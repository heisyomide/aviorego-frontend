  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role === 'CUSTOMER') {
        ...
        // Change from user.status check to user.identityStatus or whatever matches your schema if status behaves differently
    ...
    <div className="flex min-h-screen bg-zinc-50 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-emerald-50 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="z-10 text-center max-w-md">
          ...
          {/* Desktop Illustration Placeholder (Replace with actual SVG/Image) */}
          <div className="relative w-80 h-80 mx-auto mb-8">
            <Image 
              src="/images/delivery-illustration.svg" // Replace with your actual illustration path
              alt="Delivery Rider"
              fill
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-md bg-white rounded-3xl border border-zinc-200 p-8 shadow-sm">
          ...
          {/* MOBILE HEADER: Shows only on mobile (matches the mockup) */}
          <div className="lg:hidden flex flex-col items-center mb-8">
            ...
            <div className="w-48 h-32 relative">
               <Image 
                src="/images/delivery-illustration-mobile.svg" // Replace with actual path
                alt="Delivery Rider"
                fill
                className="object-contain"
              />
